...
public class SkullShooterBullet extends Bullet {
    public SkullShooterBullet(TextureRegion[] bulletIdleAnimationFrames, float iniX, float iniY, float width, float height,
            float dx, float dy, SpriteBatch batch) {
        super(bulletIdleAnimationFrames, iniX, iniY, width, height, dx, dy, batch);
