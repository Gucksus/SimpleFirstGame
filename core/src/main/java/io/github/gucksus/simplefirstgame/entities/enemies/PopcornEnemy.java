...
public class PopcornEnemy extends Enemy {
    public PopcornEnemy(TextureRegion staticTexture, float iniX, float iniY, float worldWidth,
            float worldHeight, MainShip mainShip, SpriteBatch batch, DebugRenderer debugRenderer,
            Wave wave) {
        super(staticTexture, iniX, iniY, 1, 1, worldWidth, worldHeight, mainShip, batch,
                debugRenderer, wave);
        health = 1f;
